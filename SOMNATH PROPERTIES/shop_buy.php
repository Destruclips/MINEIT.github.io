...
<body>
    ...
    <div class="searchresults">
        <h1>Search results for <?php echo $GET['search']?> </h1>
        <div class="result">
            <h1>cannot install pyaudio</h1>
        </div>
    </div>
    <section class="container">
        <form action="">
            <i class = "fas fa-search"> </i>
            <input type="text" method = "get" action="search.php" name ="" id="search-item" placeholder = "Search Places" onkeyup = "search()">
        </form>
    </section>
    <?php
    $sel = "SELECT * FROM shop_buy";
